...
Namespace DXGrid_AssignComboBoxToColumn
	...
	Public Class GridSelectingBehavior
		...
		Private Sub OnViewLayoutUpdated(ByVal sender As Object, ByVal e As EventArgs)
			If View.MultiSelectMode = TableViewSelectMode.None Then
		...
		Private Sub UpdateCurrentSelectionInfo()
            ...
            Dim rightColumnWhenUnselect As GridColumn = Nothing
		...
		Private Sub UpdateSelection()
			View.BeginSelection()
			View.ClearSelection()
            If View.MultiSelectMode = TableViewSelectMode.Row Then
