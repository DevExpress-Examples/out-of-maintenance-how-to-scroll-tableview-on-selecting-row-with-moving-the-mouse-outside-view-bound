...
Namespace DXGrid_AssignComboBoxToColumn
	Public Class ScrollController
		...
		Public ReadOnly Property IsScrollWorking() As Boolean
			...
			End Get
		End Property
        Public Event ScrollUp(ByVal sender As Object, ByVal e As EventArgs)
        Public Event ScrollDown(ByVal sender As Object, ByVal e As EventArgs)
        Public Event ScrollRight(ByVal sender As Object, ByVal e As EventArgs)
        Public Event ScrollLeft(ByVal sender As Object, ByVal e As EventArgs)
